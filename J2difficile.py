...
def perdu():
    ...
    if score1 != 11 and score2 != 11:
        ...
        Canevas.create_text(500,300,text="VICTOIRE JOUEUR 1",font="BolsterBold 70",fill='red')
        Canevas.create_text(500,500,text="APPUYEZ SUR ECHAP POUR CONTINUER",font="BolsterBold 20", fill='white')
    else:
        Canevas.create_text(500,300,text="VICTOIRE JOUEUR 2",font="BolsterBold 70",fill='blue')
        Canevas.create_text(500,500,text="APPUYEZ SUR ECHAP POUR CONTINUER",font="BolsterBold 20", fill='white')
...
Fenetre = Tk()
Fenetre.title("PONG : 2 JOUEURS NIVEAU DIFFICILE")
